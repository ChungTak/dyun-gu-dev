...
| CORE6-08 | In Progress | branch `devin/1784471000-cabi-v2-wire-types` | v2 wire 类型：`int32_t` 枚举入参、view 类型、struct size/version、`dg_abi_version` 2.0；`core6_cabi` 回归 | split 为 3 个演进 PR，当前为 split 1/3 |
