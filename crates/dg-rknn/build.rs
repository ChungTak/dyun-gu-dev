...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .derive_default(true)
        .derive_eq(true)
        .rustified_enum("rknn_query_cmd")
        .rustified_enum("rknn_tensor_type")
        .rustified_enum("rknn_tensor_format")
        .rustified_enum("rknn_tensor_qnt_type")
        .rustified_enum("rknn_core_mask")
